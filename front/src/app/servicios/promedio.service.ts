...
export class PromedioService {
  ...
  readonly URL_API='http://localhost:3000/Inicio/Promedio';
  readonly URL_API_MiPromedio='http://localhost:3000/Inicio/Promedio/PromCursosPorArea';

  /**Promedio Area */
  readonly URL_API_PromSgnNroClo='http://localhost:3000/Inicio/PromedioArea/PromSgnNroClo';
  readonly URL_API_LibretaPrd='http://localhost:3000/Inicio/PromedioArea/LibretaPrd';
